...
public class NoticesService : INoticesService
{
    ...
    public NoticesService(IProductsService productsService, INoticesRepository repo, UsersController usersController, IMapper mapper)
    {
    ...
    //     {
    //         response.ProductResponses = Notice.Products.Select(product => _productsService.ToProductResponseDTO(product)).ToList();
    //     }
